#!/usr/bin/env python3
"""Generate LightGBM regression test case (numeric features only)."""
...
def main():
    print("=" * 70)
    print("LightGBM - Regression (Numeric Features Only)")
    print("=" * 70)
    ...
    print("\n[2/4] Training LightGBM regressor...")
    # init_score=0 so base_score in IR stays 0.0 (no boost_from_average offset)
    ...
    with open(output_dir / "metadata.json", "w") as f:
        json.dump({
            "format": "lightgbm", "task": "regression",
