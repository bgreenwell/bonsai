...
and a `ground_truth` column. `one_hot_max_size=10` keeps all three
categories below the one-hot threshold so CatBoost emits OneHotFeature
splits instead of CTRs.
"""
...
def main():
    print("=" * 70)
    print("CatBoost - Regression (Native Categorical via One-Hot Splits)")
    print("=" * 70)
